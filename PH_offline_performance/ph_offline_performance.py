...
class TimeTests(unittest.TestCase):
    ...
    def test_00002_bsmana(self):
        ...
        show = self.driver.find_element_by_css_selector("#file-list-grid > div.summary").text
        url_now = self.driver.current_url
        #有找到Table中的元素(view圖示),table出來才算搜尋結束       
        if self.driver.find_element_by_xpath("/html/body/div[1]/div[3]/div[2]/table/tbody/tr[1]/td[18]/a/img"):
            ...
            total = eTime - sTime
            print("Search Condition: \n" + "Start Date: "+ sdate + "\n" + "End Date: "+ edate)
            print("*** Deposit Bank Statement search cost " + str(Decimal(total).quantize(Decimal('0.00'))) + "seconds.***")
            if total > 30.00:
                print("Loading cost over 30sec!")    
        self.assertIn("bankStatement/deposit",url_now, msg="Wrong Page!")
        self.assertIn("Displaying",show, msg="Display Error!")
    ...
    def test_00003_deposittran(self):
        ...
        if self.driver.find_element_by_xpath("/html/body/div[1]/div[3]/div[2]/div/table/tbody/tr[1]/td[25]/a/img"):
            ...
            total = eTime - sTime
            print("Search Condition: \n" + "Start Date: "+ sdate+ "\n" +"End Date: "+ edate)
            print("*** Deposit Transation search cost " + str(Decimal(total).quantize(Decimal('0.00'))) + "seconds.***")
            if total > 30.00:
                print("Loading cost over 30sec!")
