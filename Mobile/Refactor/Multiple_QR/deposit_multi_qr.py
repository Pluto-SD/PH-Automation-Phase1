...
class Deposit_by_QR():
    def __init__(self, method):
        ...
        self.amount = load_amt()       # 從外部檔案(CSV)讀取 deposit amount
    ...
    def deposit_by_mobile_qr(self):
        ...
        if self.method == 'WeChat':
            self.driver.find_element_by_css_selector("input#txn_amt").send_keys(self.amount[0][1])
        elif self.method == 'QQ':
            self.driver.find_element_by_css_selector("input#txn_amt").send_keys(self.amount[1][1])
        elif self.method == 'Alipay':
            self.driver.find_element_by_css_selector("input#txn_amt").send_keys(self.amount[2][1])
        elif self.method == 'CUP':
            self.driver.find_element_by_css_selector("input#txn_amt").send_keys(self.amount[3][1])
        ...
        self.driver.find_element_by_css_selector("input[value='086097']").click()        # 掃碼支付: 086097
        ...
        if self.method == 'WeChat':
            self.driver.find_element_by_css_selector("input[id='086081']").click()      # 086081: 微信支付 / 086082: QQ錢包 /  086083: 支付寶 /  086084: 銀聯二維碼支付
        elif self.method == 'QQ':
            self.driver.find_element_by_css_selector("input[id='086082']").click()      # 086081: 微信支付 / 086082: QQ錢包 /  086083: 支付寶 /  086084: 銀聯二維碼支付
        elif self.method == 'Alipay':
            self.driver.find_element_by_css_selector("input[id='086083']").click()      # 086081: 微信支付 / 086082: QQ錢包 /  086083: 支付寶 /  086084: 銀聯二維碼支付
        elif self.method == 'CUP':
            self.driver.find_element_by_css_selector("input[id='086084']").click()      # 086081: 微信支付 / 086082: QQ錢包 /  086083: 支付寶 /  086084: 銀聯二維碼支付
...
if __name__ == '__main__':
    wechat = Deposit_by_QR('WeChat')
    wechat.deposit_by_mobile_qr()
    sleep(3)
    qq = Deposit_by_QR('QQ')
    qq.deposit_by_mobile_qr()
    sleep(3)
    alipay = Deposit_by_QR('Alipay')
    alipay.deposit_by_mobile_qr()
    sleep(3)
    cup = Deposit_by_QR('CUP')
    cup.deposit_by_mobile_qr()
